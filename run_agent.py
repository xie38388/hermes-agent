...
class AIAgent(LLMClientMixin, ToolLoopMixin, StreamHandlerMixin, APICallerMixin, ContextManagerMixin, ResponsesAPIMixin, SessionPersistenceMixin, AgentHelpersMixin, PromptBuilderMixin, ConversationMixin):
    """
